...
def read_frecuencies(file=os.path.join(PROJECT_ROOT, 'data/10000_formas.TXT'), 
		     lemario_file=os.path.join(PROJECT_ROOT, 'data/lemario.txt'), min = 0):
    frecuencies = {}
...
NWORDS = train( words( read_dict([os.path.join(PROJECT_ROOT, 'data/news.txt'), 
		                  os.path.join(PROJECT_ROOT, 'data/conjugations.txt'), 
		                  os.path.join(PROJECT_ROOT, 'data/words.txt')]
			) ) )
